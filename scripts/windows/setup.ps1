...
function Main {
    ...
    Write-Host "║  1. Run: .\scripts\windows\case-study-3.ps1             ║" -ForegroundColor Green
    Write-Host "║  2. Run: .\scripts\windows\case-study-4.ps1             ║" -ForegroundColor Green
    Write-Host "║  (Subscription is auto-detected at runtime)             ║" -ForegroundColor Green
    Write-Host "╚══════════════════════════════════════════════════════════╝" -ForegroundColor Green
}
